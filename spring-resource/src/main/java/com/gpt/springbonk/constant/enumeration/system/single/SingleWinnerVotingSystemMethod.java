    ...
    //implements VotingSystemMethod
{
    ...
    INSTANT_RUNOFF(
        RANKING,
        EnumSet.of(
            MAJORITY_WINNER, MAJORITY_LOSER, MUTUAL_MAJORITY, CONDORCET_LOSER, CLONE_PROOF, LATER_NO_HARM,
            LATER_NO_HELP
        )
    ),
    COOMBS(
        RANKING,
        EnumSet.of(MAJORITY_WINNER, MAJORITY_LOSER, MUTUAL_MAJORITY, CONDORCET_LOSER, NO_FAVORITE_BETRAYAL)
    ),
    NANSON(
        RANKING,
        EnumSet.of(MAJORITY_WINNER, MAJORITY_LOSER, MUTUAL_MAJORITY, CONDORCET_WINNER, CONDORCET_LOSER, SMITH)
    ),
    /**
    ...
    TIDEMAN_ALTERNATIVE(
        RANKING,
        EnumSet.of(
            MAJORITY_WINNER, MAJORITY_LOSER, MUTUAL_MAJORITY, CONDORCET_WINNER, CONDORCET_LOSER, SMITH, SMITH_IIA,
            CLONE_PROOF
        )
    ),
    ...
    KEMENY_YOUNG(
        RANKING,
        EnumSet.of(
            MAJORITY_WINNER, MAJORITY_LOSER, MUTUAL_MAJORITY, CONDORCET_WINNER, CONDORCET_LOSER, SMITH, SMITH_IIA, LIIA,
            MONOTONE
        )
    ),
    RANKED_PAIRS(
    ...
    APPROVAL(
        APPROVALS,
        EnumSet.of(
            MAJORITY_WINNER, IIA, LIIA, CLONE_PROOF, MONOTONE, PARTICIPATION, LATER_NO_HELP, NO_FAVORITE_BETRAYAL)
    ),
    MAJORITY_JUDGEMENT(
        SCORES,
    ...
    SCORE(
        SCORES,
        EnumSet.of(IIA, LIIA, CLONE_PROOF, MONOTONE, PARTICIPATION, LATER_NO_HELP, NO_FAVORITE_BETRAYAL)
    ),
    STAR(
        SCORES,
    ...
    RANDOM_BALLOT(
        SINGLE_MARK,
        EnumSet.of(IIA, LIIA, CLONE_PROOF, MONOTONE, PARTICIPATION, LATER_NO_HARM, LATER_NO_HELP, NO_FAVORITE_BETRAYAL)
    ),
    /**
    ...
    SORTITION(
        NONE,
        EnumSet.of(IIA, LIIA, MONOTONE, PARTICIPATION, LATER_NO_HARM, LATER_NO_HELP, NO_FAVORITE_BETRAYAL)
    );
