...
public class ElectionCannotBeCompletedException extends RuntimeException {
  public final static String NO_ELECTION_MESSAGE =
      "Election cannot proceed without a specified election";
  public final static String NO_CANDIDATES_MESSAGE =
      "Election cannot proceed without any candidates.";
