/**
 * Reasons a candidate might be eliminated during ranked-choice rounds.
 */
export enum EliminationMessage {
  WINNER_MAJORITY = "Winner elected by possessing greater than 50% of the votes cast in round.",
  WINNER_ATTRITION = "Winner did not achieve greater than 50% of the votes cast in any round, but is the only candidate remaining.",
